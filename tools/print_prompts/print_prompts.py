#!/usr/bin/env python3
"""CLI to print NOVA prompts (behavior_prompts and Reply_prompts).
...
def main():
    parser = argparse.ArgumentParser(description="Print NOVA prompts")
    ...
    try:
        ...
        print(f"Failed to import NOVA_prompts: {e}")
        sys.exit(2)
